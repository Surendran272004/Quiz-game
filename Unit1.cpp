...
Question q1 = Question("Which colour does not appear on olympic ring?","Black","Orange","Green","White",2);
...
//---------------------------------------------------------------------------
void __fastcall TForm1::Answer3RadioButton3Change(TObject *Sender)
{
	selectAnswer=3;
}
//---------------------------------------------------------------------------
void __fastcall TForm1::Answer4RadioButton4Change(TObject *Sender)
{
   selectAnswer=4;
}
//---------------------------------------------------------------------------
void __fastcall TForm1::ConfirmButton1Click(TObject *Sender)
{
